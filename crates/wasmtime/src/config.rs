...
impl Config {
    ...
    /// Configures whether components are allowed to use nested namespaces,
    /// packages, and projections in import and export names, for example
    /// `a:b:c/d/e/f`.
    ///
    /// This corresponds to the 🪺 emoji in the component model specification.
    #[cfg(feature = "component-model")]
    pub fn wasm_component_model_nested_names(&mut self, enable: bool) -> &mut Self {
        self.wasm_features(WasmFeatures::CM_NESTED_NAMES, enable);
        self
    }
